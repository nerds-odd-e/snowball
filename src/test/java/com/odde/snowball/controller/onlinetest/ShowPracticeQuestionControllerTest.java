...
public class ShowPracticeQuestionControllerTest {
    private ShowPracticeQuestionController controller;
    ...
    public void setUpMockService() {
        controller = new ShowPracticeQuestionController();
    }
    ...
    public void itMustSetTheCurrentQuestion() throws ServletException, IOException {
        ...
        assertThat(response.getForwardedUrl()).isEqualTo("/practice/question.jsp");
