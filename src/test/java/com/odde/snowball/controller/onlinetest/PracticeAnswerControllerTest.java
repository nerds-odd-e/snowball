...
public class PracticeAnswerControllerTest {
    private PracticeAnswerController controller;
    ...
    public void setUpMockService() {
        controller = new PracticeAnswerController();
    ...
    public void postIncorrect() throws ServletException, IOException {
        ...
        assertThat(response.getForwardedUrl()).isEqualTo("/practice/advice.jsp");
    }
