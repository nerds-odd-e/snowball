...
@WebServlet("/practice/question")
public class ShowPracticeQuestionController extends AppController {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(currentQuestion != null) {
            ...
            req.getRequestDispatcher("/practice/question.jsp").forward(req, resp);
            return;
        }
